...
The whole exam is in a `.pdf` file in case you have connection problems. Search for the file `exam.pdf` in the Files tab and download it as first thing to do!
</div>

<div class="alert alert-danger">
As the second thing, download the file `exam-0.1.0.0.tar.gz` (Check Files tab)
</div>
...
1. You will join the meeting with a mute microphone.

2. Once you get into the meeting, you should write "I have a question" in the chat.

3. There will be a "breakout room" (some sort of separate room) where the
teacher will move you when it is your turn (according to the timestap of your
mesage in point 2)).  In that breakout room, you can chat one-to-one without the
rest listening to your question.
